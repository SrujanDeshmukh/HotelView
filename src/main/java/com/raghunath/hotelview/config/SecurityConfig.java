    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/employees/register", "/api/v1/orders/completed/**", "/api/v1/orders/completed/delivery/today", "/api/v1/orders/dashboard/stats", "/api/v1/employees/list").hasRole("ADMIN")
