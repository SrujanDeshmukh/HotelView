...
// 4. Order Operations: Waiters and Admins
                                .requestMatchers("/api/v1/orders/draft/**", "/api/v1/orders/completed/**", "/api/v1/orders/completed/delivery/today", "/api/v1/orders/dashboard/stats", "/api/v1/orders/confirm/**", "/api/v1/orders/table/**", "/api/v1/orders/checkout").hasAnyRole("WAITER", "ADMIN")
